...
if __name__ == '__main__':
    ...
    # Assuming set_background function is defined elsewhere in your code and bg_image is defined appropriately.
    ...
    # Assuming x and y variables are defined from the previous steps.
