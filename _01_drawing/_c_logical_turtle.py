...
def screen_clicked(x, y):
    ...
    deniz.speed(10)
    deniz.pendown()
    deniz.circle(300, steps=100)
    deniz.penup()
    deniz.goto(0, -150)
    deniz.pendown()
    deniz.begin_fill()
    deniz.circle(150, steps=100)
    deniz.end_fill()
    deniz.goto(0, 0)
